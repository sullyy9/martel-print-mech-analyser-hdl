...
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets mech_clk_IBUF]
...
set_property -dict { PACKAGE_PIN B18   IOSTANDARD LVCMOS33 } [get_ports { reset_button }]; #IO_L19P_T3_16 Sch=btn[1]
...
set_property -dict {PACKAGE_PIN L3 IOSTANDARD LVCMOS33} [get_ports mech_data]; #IO_L8P_T1_AD14P_35 Sch=pio[02]
set_property -dict {PACKAGE_PIN A16 IOSTANDARD LVCMOS33} [get_ports mech_clk]; #IO_L12P_T1_MRCC_16 Sch=pio[03]
set_property -dict {PACKAGE_PIN K3 IOSTANDARD LVCMOS33} [get_ports mech_dst]; #IO_L7N_T1_AD6N_35 Sch=pio[04]
set_property -dict {PACKAGE_PIN C15 IOSTANDARD LVCMOS33} [get_ports mech_motor_phase_a]; #IO_L11P_T1_SRCC_16 Sch=pio[05]
set_property -dict {PACKAGE_PIN H1 IOSTANDARD LVCMOS33} [get_ports mech_motor_phase_b]; #IO_L3P_T0_DQS_AD5P_35 Sch=pio[06]
set_property -dict { PACKAGE_PIN A15   IOSTANDARD LVCMOS33 } [get_ports { uart_tx_pin_2  }]; #IO_L6N_T0_VREF_16 Sch=pio[07]
...
set_property -dict { PACKAGE_PIN N3    IOSTANDARD LVCMOS33 } [get_ports { mech_latch }]; #IO_L12P_T1_MRCC_35 Sch=pio[18]
...
set_property -dict { PACKAGE_PIN W6    IOSTANDARD LVCMOS33 } [get_ports { mech_clk_out }]; #IO_L13N_T2_MRCC_34 Sch=pio[43]
set_property -dict { PACKAGE_PIN U3    IOSTANDARD LVCMOS33 } [get_ports { mech_data_out }]; #IO_L9P_T1_DQS_34 Sch=pio[44]
set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33 } [get_ports { mech_latch_out }]; #IO_L19P_T3_34 Sch=pio[45]
set_property -dict { PACKAGE_PIN W7    IOSTANDARD LVCMOS33 } [get_ports { mech_dst_out }]; #IO_L13P_T2_MRCC_34 Sch=pio[46]
set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS33 } [get_ports { mech_motor_phase_a_out }]; #IO_L14P_T2_SRCC_34 Sch=pio[47]
set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33 } [get_ports { mech_motor_phase_b_out }]; #IO_L14N_T2_SRCC_34 Sch=pio[48]

set_property PULLTYPE PULLUP [get_ports mech_motor_phase_a];
set_property PULLTYPE PULLUP [get_ports mech_motor_phase_b];

## UART
set_property -dict {PACKAGE_PIN J18 IOSTANDARD LVCMOS33} [get_ports uart_tx_pin_1]
#set_property -dict {PACKAGE_PIN J17 IOSTANDARD LVCMOS33} [get_ports uart_rx_pin]
